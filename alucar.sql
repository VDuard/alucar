...
--
-- Host: 127.0.0.1
-- Generation Time: 12-Jun-2018 às 02:18
...
CREATE TABLE `aluguel` (
  ...
  `usuario_idFuncionario` int(10) DEFAULT NULL,
  `usuario_idCliente` int(10) NOT NULL,
  `carro_idCarro` int(10) NOT NULL,
...
INSERT INTO `aluguel` (`idAluguel`, `usuario_idFuncionario`, `usuario_idCliente`, `carro_idCarro`, `horario`, `dataDevolucao`) VALUES
(2, NULL, 3, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(3, NULL, 3, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(4, NULL, 3, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(5, NULL, 3, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(6, NULL, 3, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(7, NULL, 3, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(8, NULL, 3, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(9, NULL, 3, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(10, NULL, 3, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(11, NULL, 5, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(12, NULL, 5, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(13, NULL, 5, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(14, NULL, 5, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(15, NULL, 5, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(16, NULL, 5, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(17, NULL, 5, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(18, NULL, 5, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(19, NULL, 5, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(20, NULL, 5, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(21, NULL, 5, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(22, NULL, 5, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00'),
(23, NULL, 3, 1, '2018-06-10 00:00:00', '2018-07-08 00:00:00');
...
CREATE TABLE `carro` (
  ...
  `statusDoCarro` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `carro` (`idCarro`, `placa`, `modelo`, `cor`, `tipo`, `renavam`, `valorAluguel`, `statusDoCarro`) VALUES
(1, 'ABC-0001', 'Gol', 'vermelho', 'Economico', '19815075074', 50.5, 'Disponivel'),
(2, 'ABC-0002', 'HB20', 'branco', 'Intermediario', '54429858883', 60.5, 'Disponivel'),
(3, 'ABC-0003', 'Uno', 'grafite', 'Economico', '29358730285', 65.5, 'Disponivel'),
(4, 'ABC-0004', 'Civic', 'prata', 'Passeio', '53917532270', 80, 'Disponivel'),
(5, 'ABC-0005', 'Ka', 'prata', 'Intermediario', '55357156274', 60.5, 'Disponivel');
...
CREATE TABLE `checklist` (
  ...
  `multa_idmulta` int(10) NOT NULL,
  `devolucao_idDevolucao` int(10) DEFAULT NULL,
  `aluguel_idAluguel` int(10) NOT NULL,
...
CREATE TABLE `cidade` (
  `cod_cidade` varchar(6) NOT NULL,
  `nom_cidade` varchar(60) NOT NULL,
  `est_cidade` varchar(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `cidade` (`cod_cidade`, `nom_cidade`, `est_cidade`) VALUES
...
('210740', 'OLHO DAGUA DAS CUNHAS', 'MA'),
...
('220965', 'S.FRANCISCO DE ASSIS DO PIAUI', 'PI'),
...
('240830', 'NOVA CRUZ', 'RN'),
('240840', 'OLHO DAGUA DO BORGES', 'RN'),
('240850', 'OURO BRANCO', 'RN'),
('240860', 'PARANA', 'RN'),
('240870', 'ESPIRITO SANTO DO OESTE', 'RN'),
('240880', 'PARAZINHO', 'RN'),
('240890', 'PARELHAS', 'RN'),
...
('270550', 'MURICI', 'AL'),
('270560', 'NOVO LINO', 'AL'),
('270570', 'OLHO DAGUA DAS FLORES', 'AL'),
('270580', 'OLHO DAGUA DO CASADO', 'AL'),
('270590', 'OLHO DAGUA GRANDE', 'AL'),
('270600', 'OLIVENCA', 'AL'),
...
('292225', 'MUQUEM DO SAO FRANCISCO', 'BA'),
('292230', 'MURITIBA', 'BA'),
('292240', 'MUTUIPE', 'BA'),
('292250', 'NAZARE', 'BA'),
...
('320220', 'FUNDAO', 'ES'),
('320225', 'GOVERNADOR LINDEMBERG', 'ES'),
('320230', 'GUACUI', 'ES'),
('320240', 'GUARAPARI', 'ES'),
('320245', 'IBATIBA', 'ES'),
('320250', 'IBIRACU', 'ES'),
...
('330100', 'CAMPOS DOS GOITACAZES', 'RJ'),
('330110', 'CANTAGALO', 'RJ'),
...
('355210', 'SOCORRO', 'SP'),
('355220', 'SOROCABA', 'SP'),
('355230', 'SUD MENUCCI', 'SP'),
('355240', 'SUMARE', 'SP'),
('355250', 'SUZANO', 'SP'),
('355255', 'SUZANOPOLIS', 'SP'),
('355260', 'TABAPUA', 'SP'),
('355270', 'TABATINGA', 'SP'),
...
('412330', 'SANTA CRUZ DO MONTE CASTELO', 'PR'),
('412340', 'SANTA FE', 'PR'),
...
('421690', 'SAO LOURENCO D\'OESTE', 'SC'),
...
('510530', 'LUCIARA', 'MT'),
('510550', 'VILA BELA SANTISSIMA TRINDADE', 'MT'),
...
INSERT INTO `estado` (`cod_estado`, `sig_estado`, `nom_estado`) VALUES
(1, 'AC', 'ACRE'),
(2, 'AL', 'ALAGOAS'),
(3, 'AM', 'AMAZONAS'),
(4, 'AP', 'AMAPA'),
...
INSERT INTO `funcao` (`idfuncao`, `nome`, `gratific`) VALUES
(1, 'Motorista', 10),
(2, 'Gerente', 15),
(3, 'Atendente', 10),
(4, 'Cliente', 0);
...
INSERT INTO `hierarquia` (`idhierarquia`, `nome`, `descricao`) VALUES
...
INSERT INTO `multa` (`idmulta`, `infracao`, `valor`) VALUES
(1, 'Juros por Dia', 3.5),
(2, 'Desistencia', 50),
(3, 'Atraso de Devolucao', 50),
(4, 'Danos ao Veiculo s/ ', 60),
(5, 'Normal', 0);
...
CREATE TABLE `ordemdeservico` (
  `idOrdem` int(10) NOT NULL,
  `usuario_idCliente` int(10) NOT NULL,
  `usuario_idFuncionario` int(10) NOT NULL,
  `aluguel_idAluguel` int(10) NOT NULL,
  `tratamento` varchar(200) NOT NULL,
  `statusDaOrdem` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `ordemdeservico` (`idOrdem`, `usuario_idCliente`, `usuario_idFuncionario`, `aluguel_idAluguel`, `tratamento`, `statusDaOrdem`) VALUES
(3, 5, 7, 2, 'Motirista particular', 'nÃ£o inici'),
(4, 5, 7, 2, 'Motirista particular', 'nÃ£o inici'),
(5, 5, 7, 21, 'Motirista particular', 'nÃ£o inici'),
(6, 5, 7, 22, 'Motirista particular', 'nÃ£o inici'),
(7, 3, 7, 23, 'Motirista particular', 'nÃ£o inici');

-- --------------------------------------------------------

--
-- Estrutura da tabela `pagamentofinal`
--

CREATE TABLE `pagamentofinal` (
  `idPagamentoFinal` int(10) NOT NULL,
  `devolucao_idDevolucao` int(10) NOT NULL,
  `valor` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estrutura da tabela `pagamentoinicial`
--

CREATE TABLE `pagamentoinicial` (
  `idpagamentoInicial` int(10) NOT NULL,
  `aluguel_idAluguel` int(10) NOT NULL,
  `valor` double NOT NULL,
...
CREATE TABLE `pais` (
  ...
  `paisSiglaCurta` char(2) DEFAULT NULL,
...
INSERT INTO `pais` (`paisId`, `paisNome`, `paisSiglaCurta`, `paisSigla`) VALUES
(117, 'Kosovo', 'XK', '---'),
(13, 'Aruba', 'AW', 'ABW'),
...
CREATE TABLE `usuario` (
  ...
  `hierarquia_idhierarquia` int(10) NOT NULL,
  `funcao_idfuncao` int(10) NOT NULL,
  `nome` varchar(50) NOT NULL,
  ...
  `pais_idpais` char(3) NOT NULL,
  `estado_idestado` int(10) NOT NULL,
  `cidade_idcidade` varchar(6) NOT NULL,
...
INSERT INTO `usuario` (`idUsuario`, `hierarquia_idhierarquia`, `funcao_idfuncao`, `nome`, `endereco`, `complemento`, `cep`, `telefone`, `celular`, `tipo_pessoa`, `cpf`, `cnh`, `dataNasc`, `pais_idpais`, `estado_idestado`, `cidade_idcidade`, `email`, `usuario`, `senha`) VALUES
(3, 4, 4, 'Yusef Richard', 'Rua Irma Luzia Pereira da Silva\r\nnÃ‚Âº 34, casa', 'casa', '58078-29', '83999151013', '83999151013', 'J', '10924323450', '2342342', '0000-00-00 00:00:00', 'ABW', 1, '120000', 'yusef.rick@gmail.com', 'yusefrichard', 'e10adc3949ba59abbe56'),
(5, 4, 4, 'yusef', 'Rua Irma Luzia Pereira da Silva\r\nnÃ‚Âº 34, casa', 'casa', '58078-29', '83999464613', '83999151046', 'F', '10924323451', '23423425', '2018-04-11 00:00:00', 'BRA', 15, '250750', 'yusef.rick2@gmail.com', 'yusef', 'e10adc3949ba59abbe56'),
(7, 1, 1, 'Carlos Umberto Fagundes', 'R. Ademar Joaquim de Castro, 45', 'CASA', '58000000', '(083)3231-4150', '(83)98752-1163', 'F', '65013338069', '76502300702', '1998-02-20 00:00:00', 'BRA', 12, '500080', 'Umb.Carlos@email.com', 'Umb.Carlos', 'Password1@'),
(8, 1, 1, 'Ana Valentina de Sousa', 'R. Alaide Gomes da Silva, 87', 'CASA', '58000000', '(083)3231-4150', '(83)98752-1163', 'F', '65016638069', '76504820702', '1999-05-20 00:00:00', 'BRA', 12, '500080', 'Valana@email.com', 'Valana', 'Password1@'),
(9, 2, 2, 'jose santiago', 'R. irma luzia, 45', 'CASA', '58000100', '(083)3231-4650', '(83)88752-1163', 'F', '65369338069', '76951300702', '1995-02-20 00:00:00', 'BRA', 12, '500080', 'gerentejose@email.com', 'gerentejose', 'senha');
...
ALTER TABLE `aluguel`
  ...
  ADD KEY `fk_usuario_idFuncionario` (`usuario_idFuncionario`),
  ADD KEY `fk_usuario_idCliente` (`usuario_idCliente`),
  ADD KEY `fk_carro_idCarro` (`carro_idCarro`);
...
ALTER TABLE `checklist`
  ...
  ADD KEY `fk_multa_idmulta` (`multa_idmulta`),
  ADD KEY `fk_checklist_aluguel_idAluguel` (`aluguel_idAluguel`),
  ADD KEY `fk_checklist_devolucao_idDevolucao` (`devolucao_idDevolucao`);
...
ALTER TABLE `devolucao`
  ...
  ADD KEY `fk_devolucao_aluguel_idAluguel` (`aluguel_idAluguel`);
...
ALTER TABLE `ordemdeservico`
  ...
  ADD KEY `fk_ordemServico_usuario_idCliente` (`usuario_idCliente`),
  ADD KEY `fk_ordemServico_usuario_idFuncionario` (`usuario_idFuncionario`),
  ADD KEY `fk_ordemServico_aluguel_idAluguel` (`aluguel_idAluguel`);

--
-- Indexes for table `pagamentofinal`
--
ALTER TABLE `pagamentofinal`
  ADD PRIMARY KEY (`idPagamentoFinal`),
  ADD KEY `fk_pagamentoF_devolucao_idDevolucao` (`devolucao_idDevolucao`);

--
-- Indexes for table `pagamentoinicial`
--
ALTER TABLE `pagamentoinicial`
  ADD PRIMARY KEY (`idpagamentoInicial`),
  ADD KEY `fk_aluguel_idAluguel` (`aluguel_idAluguel`);

--
-- Indexes for table `pais`
--
ALTER TABLE `pais`
  ADD PRIMARY KEY (`paisSigla`);
...
ALTER TABLE `usuario`
  ...
  ADD KEY `fk_hierarquia_idhierarquia` (`hierarquia_idhierarquia`),
  ADD KEY `fk_funcao_idfuncao` (`funcao_idfuncao`),
  ADD KEY `fk_pais_idpais` (`pais_idpais`),
  ADD KEY `fk_estado_idestado` (`estado_idestado`),
  ADD KEY `fk_cidade_idcidade` (`cidade_idcidade`);
...
--
ALTER TABLE `aluguel`
  MODIFY `idAluguel` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `carro`
--
ALTER TABLE `carro`
  MODIFY `idCarro` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `checklist`
--
ALTER TABLE `checklist`
  MODIFY `idChecklist` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `devolucao`
--
ALTER TABLE `devolucao`
  MODIFY `idDevolucao` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `estado`
--
ALTER TABLE `estado`
  MODIFY `cod_estado` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `funcao`
--
ALTER TABLE `funcao`
  MODIFY `idfuncao` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `hierarquia`
--
ALTER TABLE `hierarquia`
  MODIFY `idhierarquia` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `multa`
--
ALTER TABLE `multa`
  MODIFY `idmulta` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `ordemdeservico`
--
ALTER TABLE `ordemdeservico`
  MODIFY `idOrdem` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `pagamentofinal`
--
ALTER TABLE `pagamentofinal`
  MODIFY `idPagamentoFinal` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pagamentoinicial`
--
ALTER TABLE `pagamentoinicial`
  MODIFY `idpagamentoInicial` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `aluguel`
  ADD CONSTRAINT `fk_carro_idCarro` FOREIGN KEY (`carro_idCarro`) REFERENCES `carro` (`idCarro`),
  ADD CONSTRAINT `fk_usuario_idCliente` FOREIGN KEY (`usuario_idCliente`) REFERENCES `usuario` (`idUsuario`),
  ADD CONSTRAINT `fk_usuario_idFuncionario` FOREIGN KEY (`usuario_idFuncionario`) REFERENCES `usuario` (`idUsuario`);

--
-- Limitadores para a tabela `checklist`
--
ALTER TABLE `checklist`
  ADD CONSTRAINT `fk_checklist_aluguel_idAluguel` FOREIGN KEY (`aluguel_idAluguel`) REFERENCES `aluguel` (`idAluguel`),
  ADD CONSTRAINT `fk_checklist_devolucao_idDevolucao` FOREIGN KEY (`devolucao_idDevolucao`) REFERENCES `devolucao` (`idDevolucao`),
  ADD CONSTRAINT `fk_multa_idmulta` FOREIGN KEY (`multa_idmulta`) REFERENCES `multa` (`idmulta`);

--
-- Limitadores para a tabela `devolucao`
--
ALTER TABLE `devolucao`
  ADD CONSTRAINT `fk_devolucao_aluguel_idAluguel` FOREIGN KEY (`aluguel_idAluguel`) REFERENCES `aluguel` (`idAluguel`);

--
-- Limitadores para a tabela `ordemdeservico`
--
ALTER TABLE `ordemdeservico`
  ADD CONSTRAINT `fk_ordemServico_aluguel_idAluguel` FOREIGN KEY (`aluguel_idAluguel`) REFERENCES `aluguel` (`idAluguel`),
  ADD CONSTRAINT `fk_ordemServico_usuario_idCliente` FOREIGN KEY (`usuario_idCliente`) REFERENCES `usuario` (`idUsuario`),
  ADD CONSTRAINT `fk_ordemServico_usuario_idFuncionario` FOREIGN KEY (`usuario_idFuncionario`) REFERENCES `usuario` (`idUsuario`);

--
-- Limitadores para a tabela `pagamentofinal`
--
ALTER TABLE `pagamentofinal`
  ADD CONSTRAINT `fk_pagamentoF_devolucao_idDevolucao` FOREIGN KEY (`devolucao_idDevolucao`) REFERENCES `devolucao` (`idDevolucao`);

--
-- Limitadores para a tabela `pagamentoinicial`
--
ALTER TABLE `pagamentoinicial`
  ADD CONSTRAINT `fk_aluguel_idAluguel` FOREIGN KEY (`aluguel_idAluguel`) REFERENCES `aluguel` (`idAluguel`);

--
-- Limitadores para a tabela `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `fk_cidade_idcidade` FOREIGN KEY (`cidade_idcidade`) REFERENCES `cidade` (`cod_cidade`),
  ADD CONSTRAINT `fk_estado_idestado` FOREIGN KEY (`estado_idestado`) REFERENCES `estado` (`cod_estado`),
  ADD CONSTRAINT `fk_funcao_idfuncao` FOREIGN KEY (`funcao_idfuncao`) REFERENCES `funcao` (`idfuncao`),
  ADD CONSTRAINT `fk_hierarquia_idhierarquia` FOREIGN KEY (`hierarquia_idhierarquia`) REFERENCES `hierarquia` (`idhierarquia`),
  ADD CONSTRAINT `fk_pais_idpais` FOREIGN KEY (`pais_idpais`) REFERENCES `pais` (`paisSigla`);
COMMIT;
