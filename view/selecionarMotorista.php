    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="alugar.php"></a>
            </li>
...
<div class="container mt-5">
        ...
        <div class="col-md-12">
            ...
            $sql = "SELECT * FROM `usuario` WHERE funcao_idfuncao = 1";
                    ...
                    echo "<table class='table table-bordered table-striped'>";
                        ...
                        while ($row = $result->fetch_array()) {
                            echo "<tr>";
                                ...
                                echo "<td>";
                                    echo "<a href='../php/view/insertOrdem.php?id=" . $row['idUsuario'] . "' title='Delete Record' data-toggle='tooltip'><span class='btn btn-primary'>Selecionar Motorista</span></a>";
                                echo "</td>";
                            echo "</tr>";
                        }
                        echo "</tbody>";
...
<div class="container">
<a class="btn btn-outline-light" style="background-color:#ff6600;" href="aluguelAtual.php">Alugar Sem Motorista</a> 
