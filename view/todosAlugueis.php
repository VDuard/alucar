...
<div class="container mt-5">
        ...
        <div class="col-md-12">
            ...
            $sql = "SELECT a.*, c.modelo FROM aluguel a INNER JOIN carro c ON (a.carro_idCarro = c.idCarro) ";
                    ...
                    echo "<table class='table table-bordered table-striped'>";
                        ...
                        while ($row = $result->fetch_array()) {
                            echo "<tr>";
                                ...
                                echo "<td>";
                                    echo "<a href='../php/view/delete.php?id=" . $row['idAluguel'] . "' title='Delete Record' data-toggle='tooltip'><span class='btn btn-danger'>Cancelar/Concluir Aluguel</span></a>";
                                echo "</td>";
                            echo "</tr>";
                        }
                        echo "</tbody>";
